...
function handleFile(event) {
    ...
    Papa.parse(file, {
        ...
        complete: function (results) {
            ...
            // Envía la lista al servidor mediante una solicitud AJAX
            enviarDatosAlServidor(listInfo);
        }
    });
}
...
function enviarDatosAlServidor(datos) {
    // Realiza una solicitud AJAX al controlador para enviar los datos al servidor
    // Aquí deberías adaptar la URL y el método según tu configuración del controlador
    $.ajax({
        url: '/Funcionario/CargarCsv', // Reemplaza con la URL correcta
        type: 'POST',
        contentType: 'application/json',
        data: JSON.stringify(datos), // Envía directamente la lista de datos
