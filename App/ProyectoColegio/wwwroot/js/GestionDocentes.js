...
function generatableProfesores(data) {
    ...
    let tabla = generarTablaCargueInventario(
        ...
        [
            ...
            { valor: "Informaci√≥n Laboral", size: "20" },
            { valor: "Informaci√≥n Adicional", size: "20" },
        ...
        [
            ...
            [
                { titulo: "N√∫mero de tel√©fono", valor: "telefonoFijo" },
                { titulo: "Direcci√≥n", valor: "direccion" },
                { titulo: "Tel√©fono", valor: "telefonoCelular" },
...
function guardardocentes() {
    ...
    if (camposSincompleta.length > 0) {
        mostrarError("Error en al agregar Docente", "Por favor, complete todos los campos obligatorios indicados a continuaciÛn.", camposSincompleta);
...
function activarEscuchaSelectMateria(Nombre) {
    ...
    selectElement.addEventListener("change", function () {
        ...
        selectedText !== 'Selecciona una opciÛn' ? listarMateriaporGrado("", Nombre, selectedText) : ''
...
function activarEscuchaSelectGrupo(Nombre) {
    ...
    selectElement.addEventListener("change", function () {
        ...
        selectedText !== 'Selecciona una opciÛn' ? listargruposTitular("", Nombre, selectedText) : ''
