...
GRANT EXECUTE ON PROCEDURE db_aa74fb_bdcoleg.obtenerCodigoEstudiantes TO 'root'@'localhost';
GRANT EXECUTE ON FUNCTION db_aa74fb_bdcoleg.ObtenerCodigoEstudiante TO 'root'@'localhost';
FLUSH PRIVILEGES;
...
call ObtenerAsignaturasGrado("LA AGUILILLA", 7);
...
call registrarDocenteAsignatura("RENAN EIGMERLOZANO OSPINA", "Edu. Física"); 
...
drop FUNCTION obtenerSumatoriaPromediosPeriodosEstudianteAnno;
...
call ObtenerNombreDocente(96360484);
...
select obtenerInasistenciaEstudianteAsignatura(106602, "Matemáticas");
select obtenerCargaHorariaAsignatura("Matemáticas", "601", "Primer Periodo");

call ObtenerSumaNotaMateriaPeriodos(106684, "Matemáticas", "601");
select obtenerPromedioEstudiantePeriodo(106602, "601", "Primer Periodo");
...
SELECT ObtenerIdEstudiante(1212213246);
...
call ActualizarPosicionEstudiantes2(1212213246, 3, "601", "Primer Periodo");
/*idEstudianteRef bigint, puestoRef int, nota varchar(400), periodoRef varchar(400)*/
call ActualizarPosicionEstudiantes2(1115950341, 1, "Primer Periodo", "601"); /*LA NOTA ES CALCULADA*/
call ObtenerPosicionEstudiantesGrupo("Primer Periodo", "601");
select obtenerSumatoriaPromediosPeriodosEstudianteAnno(106602, "601");
select obtenerPromedioEstudiantePeriodo(106602, "601", "Primer Periodo");
select obtenerPromedioEstudiantePeriodo(106602, "601", "Segundo Periodo");
select obtenerPromedioEstudiantePeriodo(106602, "601", "Tercer Periodo");
select obtenerPromedioEstudiantePeriodo(106602, "601", "Cuarto Periodo");
select((2.90714+3.45714+3.45+3.67143) / 4);	
call ObtenerPuestoEstudianteBoletin(1115950133, "601");
call registrarAsignaturaGradoGrupo2("Trigonometria", "1101", 2);
call registrarAsignaturaGradoGrupo2("Trigonometria", "1001", 2);
drop FUNCTION ObtenerNombreSede;
call ObtenerInfoFamiliaresEstudiante_Certificados(1211713723);
call ObtenerInfoFamiliaresEstudiante_Certificados(1212213246);
select ObtenerNombreEstudiante(106600);
select CONCAT(1212213246, ' ');

call obtenerImagen("FirmaRector.png");
call obtenerFoto(1211713723);
select EstudianteEsInternado(106602);
        
select obtenerGradoEstudiante(1211713723);
select obtenerGrupoEstudiante(1211713723);
select obtenerSedeEstudiante(1211713723);
select FunexisteFotoEstudiante(1211713723);
call obtenerFoto(1211713723);
call ObtenerPeriodosAcademico();
call ActualizarEstadoPeriodo(1, "Segundo periodo"); /* 1 para activar || 0 para desactivar */

call obtenerTutilarGrupoxGrupo("601");
call actualizarPeriodosAcademico(414100, "Habilitado");
call actualizarPeriodosAcademico(414100, "Desabilitado");
call actualizarPeriodosAcademico(414101, "Habilitado");
call actualizarPeriodosAcademico(414105, "Habilitado");
call ObtenerPeriodoHabilitado();
call ObtenerGradosAsignaturasDocentes(187000);
call ObtenerGradosAsignaturasDocentes2(187000);
call ObtenerGradosAsignaturasDocentes(1116919521);
call ObtenerAsignaturasGrado2("LA AGUILILLA", "207006");
call ObtenerAsignaturasGrado("LA AGUILILLA", "6");

call ObtenerSedes();
call GradosAsignaturasDocentes("LA AGUILILLA", "6", "ESPAÑOL");

SELECT table_name
FROM information_schema.tables
WHERE table_schema = 'bdColegio';