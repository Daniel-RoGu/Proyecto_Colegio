...
CREATE TABLE `discapacidad` (
  ...
  `nombreDiscapacidad` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoDiscapacidad` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `discapacidad` VALUES (200,'Ninguna','Activo'),(201,'NO APLICA','Activo'),(202,'DISCAPACIDAD MÚLTIPLE','Activo');
