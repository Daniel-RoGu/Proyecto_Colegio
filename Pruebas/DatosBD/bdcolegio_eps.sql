...
CREATE TABLE `eps` (
  ...
  `nombreEPS` varchar(450) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoEPS` varchar(450) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`idEPS`)
...
INSERT INTO `eps` VALUES (2000,'CAPRECOM EPS','Activo'),(2001,'ASOCIACION MUTUAL LA ESPERANZA ASMET SALUD ESS','Activo'),(2002,'SALUD TOTAL S.A. E.P.S.','Activo'),(2003,'NUEVA EPS','Activo');
