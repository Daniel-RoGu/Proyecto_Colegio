...
CREATE TABLE `genero` (
  ...
  `nombreGenero` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoGenero` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `genero` VALUES (5000,'FEMENINO','Activo'),(5001,'MASCULINO','Activo');
