...
CREATE TABLE `notafinal` (
  ...
  `añoElectivo` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `calificacionAño` float NOT NULL,
  `estadoCalificacionAño` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`idNotaDefinitiva`)
) ENGINE=InnoDB AUTO_INCREMENT=414200 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
