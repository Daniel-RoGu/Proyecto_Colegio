...
CREATE TABLE `periodoacademico` (
  ...
  `periodoAcademico` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fechaInicio` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fechaFin` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoPeriodo` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`idPeriodoAcademico`)
) ENGINE=InnoDB AUTO_INCREMENT=414100 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
