...
CREATE TABLE `rol` (
  ...
  `nombreRol` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoRol` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`idRol`)
...
INSERT INTO `rol` VALUES (1600,'Estudiante','Activo'),(1601,'Coordinador','Activo'),(1602,'Docente','Activo');
