...
CREATE TABLE `rolpermiso` (
  ...
  `nombreVista` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vistaRaiz` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fkidRol` int NOT NULL,
  `fkidPermiso` int NOT NULL,
  PRIMARY KEY (`idRolPermiso`),
  KEY `fk_RolPermiso_Rol1` (`fkidRol`),
  KEY `fk_RolPermiso_Permiso1` (`fkidPermiso`),
  CONSTRAINT `fk_RolPermiso_Permiso1` FOREIGN KEY (`fkidPermiso`) REFERENCES `permiso` (`idPermiso`),
  CONSTRAINT `fk_RolPermiso_Rol1` FOREIGN KEY (`fkidRol`) REFERENCES `rol` (`idRol`)
) ENGINE=InnoDB AUTO_INCREMENT=105600 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
