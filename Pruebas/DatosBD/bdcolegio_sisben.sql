...
CREATE TABLE `sisben` (
  ...
  `nombreSisben` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoSisben` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `sisben` VALUES (1200,'Ninguno','Activo'),(1201,'A1','Activo'),(1202,'NO APLICA','Activo'),(1203,'A2','Activo'),(1204,'A3','Activo'),(1205,'C4','Activo'),(1206,'A4','Activo'),(1207,'B3','Activo');
