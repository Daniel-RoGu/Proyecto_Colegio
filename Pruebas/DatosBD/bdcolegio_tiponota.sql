...
CREATE TABLE `tiponota` (
  ...
  `tipoNota` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `porcentajeNota` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoNota` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`idTipoNota`)
) ENGINE=InnoDB AUTO_INCREMENT=900200 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
